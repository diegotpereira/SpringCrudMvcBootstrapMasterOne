              ...
              <div class="form-actions">
                   ...
                   <c:choose>
                          <c:when test="${usuarioDeslogado }">
                            ...
                            <a href="${login_url }" class="btn btn-lg btn-primary btn-block"><spring:message code="login.titulo" /></a>
                          </c:when>
                                  <c:otherwise>
...
>>>>>>> branch 'main' of https://github.com/diegotpereira/SpringCrudMvcBootstrapMasterOne.git
