    ...
    <body>
		...
		<a href="?lang=pt_BR"><img alt="Portugues" src="<spring:url value="/resources/images/brasil.jpeg" />"></a>
	        ...
	        <table class="table table-striped">
				<thead align="center">
				    <tr>
				      <th align="center" style="text-align: center"><spring:message code="home.usuarios.table.nome"/></th>
				      <th align="center" style="text-align: center"><spring:message code="home.usuarios.table.usuarionome"/></th>
				      <th align="center" style="text-align: center"><spring:message code="home.usuarios.table.dataNascimento"/></th>
				      <th align="center" style="text-align: center"><spring:message code="home.usuarios.table.perfil"/></th>
				      <th align="center" style="text-align: center"><spring:message code="home.usuarios.table.actions"/></th>
				    </tr>
				</thead>
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        ...
			        <h4 class="modal-title"><spring:message code="home.usuarios.modal.remove"/></h4>
			      </div>
			      <div class="modal-body">
			        <p><spring:message code="home.usuarios.modal.remove.description"/><strong id="modalUserName"></strong>?</p>
			        <strong id="usuarioLogadoAlert" style="display: none"><spring:message code="home.usuarios.modal.remove.observation"/></strong>
			      </div>
			      <div class="modal-footer">
			        <button type="button" class="btn btn-default" data-dismiss="modal"><spring:message code="home.usuarios.modal.remove.cancel"/></button>
			        <c:url var="remove_url" value="/user/remove/" />
			        <a id="link-remove" href="#" class="btn btn-primary" title="Edit">
			  			<spring:message code="home.usuarios.modal.remove.label"/>
	        		</a>
